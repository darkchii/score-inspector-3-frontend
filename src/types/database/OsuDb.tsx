...
export class OsuDb implements IOsuDb {
    ...
    readBeatmap(buffer: IOsuBuffer) {
        let beatmap: any = {
            ...
            RankedStatus: (buffer.ReadByte() - 3), //10 (osu db stored ranked status as unsigned byte, so we need to subtract 3 to get in line with default API values)
        ...
        beatmap = { ...beatmap, Difficulties: difficulties }; //20,21,22,23
