    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', my: 2 }}>
                ...
                <TextField label="Total Score" type="number" value={score} onChange={(e) => setScore(e.target.value)} />
...
function ToolLevelCalculatorFromLevelSection() {
    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', my: 2 }}>
                <TextField label="Level" type="number" value={level} onChange={(e) => setLevel(e.target.value)} />
